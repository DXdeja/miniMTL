class MMSpectatorStartPoints extends Actor;
...
defaultproperties
{
     Indexes(0)=(MapName="DXMP_Smuggler")
     ...
     MapSpecs(0)=(Location=(X=-300.000000,Y=-700.000000,Z=100.000000),RotSlope=1)
     MapSpecs(1)=(Location=(X=-1000.000000,Y=3000.000000),RotSlope=2)
     MapSpecs(2)=(Location=(X=-900.000000),RotSlope=1)
     MapSpecs(3)=(Location=(X=-2500.000000,Y=2000.000000,Z=800.000000),RotSlope=2)
     MapSpecs(4)=(Location=(X=-2000.000000,Y=-4000.000000,Z=2500.000000),RotSlope=2)
     MapSpecs(5)=(Location=(X=-3500.000000,Y=-800.000000,Z=400.000000),RotSlope=2)
     MapSpecs(6)=(Location=(X=1000.000000,Y=-2000.000000,Z=1500.000000),RotSlope=2)
     bHidden=True
}
